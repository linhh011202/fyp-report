...
\begin{itemize}
    ...
    \item \textbf{Frontend Dashboard Integration:} Integrate new authentication, subscription, and administration pages into the existing Gateway Dashboard using Vue.js and Vuetify, enhancing its functionality to support SSO login, payment processing, and user management.
\end{itemize}
...
The \textbf{Frontend Dashboard Integration} component extends the existing Gateway Dashboard, a Single Page Application (SPA) built with Vue.js and Vuetify, by adding several new pages and enhancing its functionality. Specifically, this project contributes authentication pages with SSO integration, a subscription management page with usage monitoring, protected routing with role based access control, and an admin interface for managing plans and users.
...
\subsection{Frontend Dashboard Integration}

\textbf{Before:} The existing Gateway Dashboard provided basic functionality but lacked pages for SSO based authentication, subscription management, and administrative controls.

\textbf{After:} This project integrates several new pages into the existing dashboard, enhancing its functionality significantly. Users can now authenticate via SSO or traditional login, view their subscription status and usage quotas, manage their profile, and upgrade or change plans. Administrators have access to additional tools for managing users, configuring subscription plans, and monitoring the overall system.
