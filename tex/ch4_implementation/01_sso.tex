...
\noindent\textbf{State Parameter for Context Preservation}\\

Figure~\ref{fig:google_sso_state_flow} illustrates how state parameters are preserved through the OAuth redirect to maintain user session context (e.g., redirect URL).
